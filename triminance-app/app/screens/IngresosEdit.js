    ...
    return(
        ...
        <View style={style.row} >
            ...
            <View style={style.margin}>
                ...
                <Text style={style.seccion}>3.Datos de contácto</Text>
                ...
                <Text style={style.seccion}>4.Anexar certificado</Text>
                ...
                <TouchableHighlight style={style.contenedor2}>
                    <Text style={style.letras1}>EDITAR</Text>
                </TouchableHighlight>
            </View>
